...
Name | Quality | Category | Load | Cost | Description
--- | --- | --- | --- | --- | ---
**Guard Dog (or young Jaguar, Boar, etc.)**  | 1  | Animals  | 12  | 50  | A dog or other similar-sized animal that underwent basic training to fight and protect its owner. Can be trained as a tame animal companion, provided you have the Survival talent with the same name. 
**Draft Horse (or Donkey, Mule)**  | 1  | Animals  | 130  | 100  | A largely untrained horse, fit to pull a vehicle but not to be ridden. See under Creatures to see its statistics.
...
**Extravagant Clothes**  | 4  | Clothes  | 1  | 2000  | Clothes worthy of a king or queen made from the most exotic materials.
