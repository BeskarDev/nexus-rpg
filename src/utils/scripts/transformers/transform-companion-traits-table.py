...
input_file = utils_dir / 'data' / 'markdown' / 'companion-traits.md'
output_file = utils_dir / 'data' / 'split-tables' / 'companion-traits.md'
...
if __name__ == "__main__":
    restructure_markdown_table(str(input_file), str(output_file))
