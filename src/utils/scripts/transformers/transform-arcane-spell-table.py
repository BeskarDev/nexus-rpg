...
input_file = utils_dir / 'data' / 'markdown' / 'arcane-spells.md'
output_file = utils_dir / 'data' / 'split-tables' / 'arcane-spells.md'
...
split_table_by_discipline(str(input_file), str(output_file))
