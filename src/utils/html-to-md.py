...
def html_table_to_dataframe(html_file):
  ...
  for row in table.find_all('tr'):
    ...
    for cell_index, cell in enumerate(row.find_all('td')):
      ...
      if headers and (headers[cell_index] == "Properties" or headers[cell_index] == "Weapons" or headers[cell_index] == "Skills" or headers[cell_index] == "Immunities" or headers[cell_index] == "Resistances" or headers[cell_index] == "Weaknesses"):
