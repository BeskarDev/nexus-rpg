	...
	return (
		<PlayingCard>
			...
			<Typography
				...
				sx={{ mb: 0.5 }}
			>
				<strong>STR</strong> {str} | <strong>AGI</strong> {agi} |{' '}
				<strong>SPI</strong> {spi} | <strong>MND</strong> {mnd}
			</Typography>
			...
			<Typography
				...
				sx={{ mb: 0.5 }}
			>
				<strong>Parry</strong> {parry} | <strong>Dodge</strong> {dodge} |{' '}
				<strong>Resist</strong> {resist}
			</Typography>
