...
const getLoadColor = (currentLoad: number, carryCapacity: number, maxCapacity: number) => 
  (theme: Theme) => {
        ...
        sx={{
          ...
          '& .MuiOutlinedInput-root': {
            '& .MuiInputBase-input.MuiOutlinedInput-input.Mui-disabled': {
              color: getLoadColor(currentLoad, carryCapacity, maxCapacity),
              ['-webkit-text-fill-color']: getLoadColor(currentLoad, carryCapacity, maxCapacity),
            },
            '& .MuiOutlinedInput-notchedOutline': {
              borderColor: getLoadColor(currentLoad, carryCapacity, maxCapacity),
              borderWidth: '2px',
            },
          },
        }}
