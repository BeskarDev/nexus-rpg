...
describe('MagicItemsConfig - Cost Calculations', () => {
  it('Q4 magic longsword +1 = 100 + 1,000 = 1,100 coins', () => {
    ...
    const longsword = baseItems['one-handed-weapon'].find(w => w.name.includes('Longsword'))!
    ...
    const materialCost = getSpecialMaterialExtraCost(bronze, 4, 'one-handed-weapon')
  ...
  it('Q5 mithril breastplate +2 = 750 + 10,000 + 5,000 = 15,750 coins', () => {
    ...
    const breastplate = baseItems['heavy-armor'].find(a => a.name.includes('Breastplate'))!
  ...
  it('Q6 flaming adamantite longsword +3 = 100 + 10,000 + 5,000 + 10,000 = 25,100 coins', () => {
    ...
    const materialCost = getSpecialMaterialExtraCost(adamantite, 6, 'one-handed-weapon')
    expect(materialCost).toBe(5000)
  ...
  it('Wearable material costs aligned with one-handed weapons', () => {
    ...
    const oneHandedCost = getSpecialMaterialExtraCost(mithril, 5, 'one-handed-weapon')
