...
const getAVTier = (av: number, isHeavy: boolean): string => {
	...
	const heavyMap: Record<number, number> = {
		1: 0,
		2: 1,
		4: 2,
		6: 3,
...
const convertAVBetweenArmorTypes = (
	av: number,
	fromHeavy: boolean,
	toHeavy: boolean,
): number | null => {
...
const PRESET_ATTACKS = [
	{
		...
		damage: '',
		description:
			"On strong/critical hit vs equal/smaller Size, target is grappled. While grappled, can't attack other targets.",
	},
	{
		name: 'Bite',
		properties: ['pierce'],
		...
		weaponDamage: 0,
		damage: '',
		description: 'On strong/critical hit, target suffers bleeding (2 x Tier).',
	},
	{
		name: 'Bite',
		...
		damage: '',
		description:
			'On strong/critical hit, target takes lasting poison damage (2 x Tier) and is poisoned for short duration.',
	},
	{
		name: 'Claw',
		...
		damage: '',
		description:
			'On strong/critical hit vs equal/smaller Size, target is knocked prone.',
	},
	{
		name: 'Claw',
		properties: ['slash'],
	...
	},
	{
		...
		weaponDamage: 0,
		damage: '',
		description: 'On strong/critical hit, target is pushed close.',
	},
	{
		name: 'Slam',
		properties: ['crush'],
		...
		weaponDamage: 0,
		damage: '',
		description: 'On strong/critical hit, target falls prone.',
	},
	{
		name: 'Beak',
		properties: ['agile', 'pierce'],
	...
	{
		name: 'Talons',
		properties: ['agile', 'light', 'slash'],
		damageType: 'physical',
		baseAttribute: '',
		weaponDamage: -1,
		damage: '',
		description: 'On strong/critical hit, target suffers bleeding (1 x Tier).',
	},
	{
		name: 'Horn',
		properties: ['pierce'],
		...
		damage: '',
		description:
			'On strong/critical hit, target is either knocked prone or pushed close (your choice).',
	},
	{
		name: 'Antlers',
		properties: ['pierce'],
	...
	},
	{
		...
		damage: '',
		description:
			"On strong/critical hit vs equal/smaller Size, target is grappled. While grappled, can't attack other targets with same pincer.",
	},
	{
		name: 'Mandibles',
		properties: ['crush'],
	...
	},
	{
		...
		damage: '',
		description:
			"On strong/critical hit vs equal/smaller Size, target is grappled and restrained. While constricted, can't attack other targets.",
	},
	{
		name: 'Fist',
		properties: ['light'],
	...
	},
	{
		...
		damage: '',
		description:
			'Can only be used if skips all Movement this turn (before and after attack).',
	},
	{
		name: 'Tongue',
		properties: ['agile', 'reach'],
		damageType: 'physical',
		baseAttribute: '',
		weaponDamage: 0,
		damage: '',
		description:
			"Deals no damage. On hit, target is grappled and pulled close. While grappled, can't attack other targets.",
	},
	{
		name: 'Death Roll',
		properties: ['crush'],
		...
		damage: '',
		description:
			'Only usable against target grappled by this creature. Gains +1 boon on roll. On hit, target is knocked prone.',
	},
	{
		name: 'Web',
		properties: ['thrown (close/short)'],
		damageType: 'physical',
		baseAttribute: '',
		weaponDamage: 0,
		damage: '',
		description:
			'Deals no damage. On hit, target is restrained. Web has 10 HP per Tier (min. 1), 0 AV, 8 Defense. Target can escape as Action (Strength + Agility vs Parry).',
	},
	{
		name: 'Rock Throw',
		properties: ['ammo', 'crush', 'thrown (close/short)'],
		damageType: 'physical',
		baseAttribute: '',
		weaponDamage: 0,
		damage: '',
	...
	},
	{
		...
		damage: '',
		description:
			'Cone in short range vs all creatures (Agility + Perception vs Resist). Ignores 1/2 AV. Once per scene.',
	},
	{
		name: 'Lightning Strike',
		properties: ['thrown (medium)'],
		damageType: 'lightning',
		baseAttribute: '',
		weaponDamage: -1,
		damage: '',
		description: 'On strong/critical hit, target is briefly staggered.',
	},
	{
		name: 'Fire Touch',
		properties: ['agile'],
		...
		damage: '',
		description:
			'On strong/critical hit, inflicts burning (2 x Tier) for short duration.',
	},
	{
		name: 'Flame Bolt',
		properties: ['thrown (short/medium)'],
		damageType: 'fire',
		baseAttribute: '',
		weaponDamage: -1,
		damage: '',
	...
	},
	{
		...
		damage: '',
		description:
			'On strong/critical hit, target is grappled and poisoned for short duration.',
	},
	{
		name: 'Whelm',
		properties: ['crush'],
		...
		damage: '',
		description:
			'Engulfs targets of equal/smaller Size. On hit, targets are grappled, restrained, and suffocating.',
	},
]
...
const PRESET_ABILITIES = [
	// Movement & Mobility
	{
		...
		properties: '',
		description:
			"Can fly with +1 Movement per turn. If on ground, can't use more than 1 Movement per turn.",
	},
	{
		name: 'Flying (Hover)',
		actionType: 'Passive',
		properties: '',
		description: 'Can fly freely by hovering with +1 Movement per turn.',
	},
	{
		name: 'Fast Movement',
		actionType: 'Passive',
		properties: '',
		description:
			'+1 Movement and can cover twice normal distance during travel.',
	},
	{
		name: 'Slow Movement',
		actionType: 'Passive',
		properties: '',
		description: "Can't spend more than 1 Movement per turn.",
	},
	{
		name: 'Natural Climber',
		actionType: 'Passive',
		properties: '',
		description: 'Can climb without treating it as difficult terrain.',
	},
	{
		name: 'Wall Climb',
		actionType: 'Passive',
		properties: '',
		description: 'Can climb on any vertical surface without rolling.',
	},
	{
		name: 'Spider Climb',
		actionType: 'Passive',
		properties: '',
		description: 'Can climb on any surface, even upside down, without rolling.',
	},
	{
		name: 'Burrow',
		actionType: 'Passive',
		properties: '',
		description:
			'Can move freely through loose earth, treating it as difficult terrain.',
	},
	{
		name: 'Earth Glide',
		actionType: 'Passive',
		properties: '',
		description:
			'Can burrow through natural earth and stone as normal Movement.',
	},
	{
		name: 'Strong Leap',
		actionType: 'Passive',
		properties: '',
		description:
			'Can jump up to short distance without rolling, even without moving before.',
	},
	...
	// Aquatic Abilities
	{
		...
		actionType: 'Passive',
		properties: '',
		description: 'Immune to drowning. Can swim with normal Movement.',
	},
	{
		name: 'Aquatic (Fast)',
		actionType: 'Passive',
		properties: '',
		description: 'Immune to drowning. Can swim with +2 Movement per turn.',
	},
	{
		name: 'Amphibious',
		actionType: 'Passive',
		properties: '',
		description:
			'Can hold breath underwater for medium duration. Can swim with normal Movement.',
	},
	{
		name: 'Deep Breath',
		actionType: 'Passive',
		properties: '',
		description:
			'Can hold breath underwater for short duration. Can swim with normal Movement.',
	},
	...
	// Senses
	{
		...
		actionType: 'Passive',
		properties: '',
		description: 'Gains +1 boon on Perception rolls based on smell.',
	},
	{
		name: 'Keen Eyes',
		actionType: 'Passive',
		properties: '',
		description: 'Gains +1 boon on Perception rolls based on sight.',
	},
	{
		name: 'Night Vision',
		actionType: 'Passive',
		properties: '',
		description:
			'Can see one range category further from sources of bright and dim light.',
	},
	{
		name: 'Darkvision',
		actionType: 'Passive',
		properties: 'medium/long',
		description:
			'Can see at medium range in absolute darkness as bright light and up to long distance as dim light.',
	},
	{
		name: 'Blindsight',
		actionType: 'Passive',
		properties: 'close',
		description:
			"Can perceive location of creatures and objects within range that aren't behind full cover.",
	},
	{
		name: 'Echolocation',
		actionType: 'Passive',
		properties: 'medium',
		description:
			'Can perceive surroundings without relying on sight within range, even around corners or behind cover.',
	},
	{
		name: 'Tremorsense',
		actionType: 'Passive',
		properties: 'medium',
		description:
			'Can perceive location of moving creatures and objects on connected surfaces in medium range.',
	},
	{
		name: 'Magic Sense',
		actionType: 'Passive',
		properties: 'long',
		description: 'Can intuitively sense sources of magic within long range.',
	},
	...
	// Combat Abilities
	{
		...
		properties: '',
		description:
			'Gains +1 boon on attacks against enemy in melee range if has more allies in melee range than enemies.',
	},
	{
		name: 'Multiattack',
		actionType: 'Passive',
		properties: '',
		description: 'Can make two attacks as Combat Action.',
	},
	{
		name: 'Pounce',
		actionType: 'Passive',
		properties: '',
		description:
			'If spends Movement towards target during turn, gains +1 boon on attack. On strong/critical hit vs equal/smaller Size, target is knocked prone.',
	},
	{
		name: 'Gore Attack',
		actionType: 'Passive',
		properties: '',
		description:
			'After moving at least short distance in straight line, gains +1 boon on next attack. On hit, increase SL by one step (max. critical).',
	},
	{
		name: 'Dive Attack',
		actionType: 'Passive',
		properties: '',
		description:
			'After flying at least short distance downwards, gains +1 boon on next attack. On hit, increase SL by one step (max. critical).',
	},
	{
		...
		properties: '',
		description:
			'When hits unaware enemy with attack for first time during scene, increase SL by one step (max. critical).',
	},
	{
		name: 'Frightful Presence',
		actionType: 'Action',
		properties: 'Recharge 5-6',
		description:
			'All enemies within close distance must resist or become frightened.',
	},
	{
		name: 'Intimidating Roar',
		actionType: 'Action',
		properties: 'Once per combat',
		description:
			'Creatures within short range must resist (Strength + Fortitude vs Resist) or become frightened. Can resist at start of turn.',
	},
	...
	// Defensive Abilities
	{
		...
		properties: '',
		description:
			'Gains +1 boon on saving throws against spells and magical effects.',
	},
	{
		name: 'Spell Reflection',
		actionType: 'Triggered',
		properties: 'Once per scene',
		description: 'When targeted by spell, can reflect it back at caster.',
	},
	{
		name: 'Regeneration',
		actionType: 'Passive',
		properties: '',
		description: 'Regains 5 HP at start of turn if has at least 1 HP.',
	},
	{
		name: 'Relentless',
		actionType: 'Triggered',
		properties: 'Once per day',
		description: 'When would suffer Wound, can choose to ignore it.',
	},
	{
		name: 'Hard Shell',
		actionType: 'Quick Action',
		properties: '',
		description: 'Can use Guard Quick Action treating shell as shield.',
	},
	{
		name: 'Shell Defense',
		actionType: 'Quick Action',
		properties: '',
		description:
			'Can withdraw into shell, gaining Guard effects and +2 AV but unable to move or attack until emerges.',
	},
	...
	// Special Forms
	{
		...
		actionType: 'Passive',
		properties: '',
		description: 'Can move through any space as narrow as one centimetre.',
	},
	{
		name: 'Water Form',
		actionType: 'Passive',
		properties: '',
		description:
			'Can move through any space as narrow as one centimetre. If suffers frost damage, is briefly slowed.',
	},
	{
		name: 'Fire Form',
		actionType: 'Passive',
		properties: '',
		description:
			'Can move through any space as narrow as keyhole. Illuminates short distance in bright light. Attackers at melee range suffer fire damage.',
	},
	{
		name: 'Undead Nature',
		actionType: 'Passive',
		properties: '',
		description: "Doesn't need to breathe, eat, drink, or sleep.",
	},
	...
	// Utility
	{
		...
		actionType: 'Passive',
		properties: '',
		description: 'Add +2 to encumbrance and over-encumbrance limits.',
	},
	{
		...
		properties: '',
		description:
			"Can be of large Size even for Tier that normally doesn't allow that Size.",
	},
	{
		name: 'Track Scent',
		actionType: 'Passive',
		properties: '',
		description:
			'Can track scent trail for up to day after made, unless foreign force influenced scent (heavy rain, etc).',
	},
	{
		name: 'Tool Usage',
		actionType: 'Passive',
		properties: '',
		description:
			'Can use simple tools and weapons (only Quality 1) after being trained with them for at least medium duration.',
	},
	{
		name: 'Web Walker',
		actionType: 'Passive',
		properties: '',
		description:
			'Can move on webs normally. Knows exact location of any creature touching web while standing on it.',
	},
	{
		name: 'Swallow',
		actionType: 'Passive',
		properties: '',
		description:
			'Can swallow one smaller creature. Target becomes blinded, restrained, takes lasting acid damage. Released when takes Wound or dies (spit out prone).',
	},
	{
		name: 'Invisibility',
		actionType: 'Action',
		properties: 'Once per scene',
		description: 'Becomes invisible until attacks or scene ends.',
	},
]
...
export const CreatureAdvancedSettings: React.FC = () => {
	...
	const [editingAttackIndex, setEditingAttackIndex] = useState<number | null>(
		null,
	)
	...
	const currentArmorType =
		customArmorType ?? archetypeData?.armorType ?? 'light'
	...
	const baseAVForCurrentType =
		currentArmorType === 'heavy' ? baseAVHeavy : baseAVLight

	// Calculate true base defenses (without custom overrides) for display in caption
	const trueBaseParry = calculateDefense(
		state.tier,
		state.archetype,
		state.size,
		'parry',
	...
	const trueBaseDodge = calculateDefense(
		state.tier,
		state.archetype,
		state.size,
		'dodge',
	...
	const trueBaseResist = calculateDefense(
		state.tier,
		state.archetype,
		state.size,
		'resist',
	...
	const handleAddAttack = () => {
		if (newAttack.name) {
			...
			if (finalAttack.baseAttribute && finalAttack.weaponDamage !== undefined) {
				...
				finalAttack.damage = formatDamageString(
					baseDamage,
					finalAttack.weaponDamage,
				)
			}
	...
	const handleDeleteAttack = (index: number) => {
		...
		dispatch(
			creatureBuilderActions.setAttacks(attacks.filter((_, i) => i !== index)),
		)
	}
	...
	const handleDeleteAbility = (index: number) => {
		...
		dispatch(
			creatureBuilderActions.setAbilities(
	...
	const handleUpdateAbility = (
		index: number,
		updatedAbility: CreatureAbility,
	) => {
				...
				<AccordionDetails sx={{ pt: 0 }}>
					<Grid container spacing={2}>
									...
									>
										...
										{getValidAVValues(
											...
											<MenuItem key={av} value={av}>
												{av}
												{getAVTier(av, currentArmorType === 'heavy')}
											</MenuItem>
										))}
									</Select>
								</FormControl>
									...
									<IconButton
										...
										onClick={() => {
											...
											if (customAV !== null && customAV !== undefined) {
												...
												if (convertedAV !== null) {
													dispatch(
														creatureBuilderActions.setCustomAV(convertedAV),
													)
												}
											} else {
												...
												if (convertedBaseAV !== null) {
													dispatch(
														creatureBuilderActions.setCustomAV(convertedBaseAV),
													)
												}
											}
										}}
						...
						<Grid item xs={12}>
							...
							>
								Attributes (Base: STR {baseStr}, AGI {baseAgi}, SPI {baseSpi},
								MND {baseMnd})
							</Typography>
						</Grid>
						<Grid item xs={6} md={3}>
							<FormControl fullWidth size="small">
								...
								<Select
									...
									onChange={(e) =>
										dispatch(
											creatureBuilderActions.setCustomAttribute({
												attr: 'str',
						...
						<Grid item xs={12}>
							...
							>
								Defenses (Base: Parry {trueBaseParry}, Dodge {trueBaseDodge},
								Resist {trueBaseResist})
							</Typography>
						</Grid>
						<Grid item xs={4}>
							<TextField
								...
								onChange={(e) =>
									dispatch(
										creatureBuilderActions.setCustomDefense({
											defense: 'parry',
				...
				<AccordionDetails sx={{ pt: 0 }}>
					<Grid container spacing={1.5}>
						<Grid item xs={12}>
							...
							<Autocomplete
								size="small"
								options={OFFICIAL_SKILLS.filter(
								...
								onChange={(_, newValue) => {
									if (newValue) {
										...
										dispatch(
											creatureBuilderActions.setSkills([...skills, newSkill]),
										)
									}
								}}
								value={null}
												...
												>
													...
													<TextField
														...
														onBlur={() => {
															...
															dispatch(
																creatureBuilderActions.setSkills(updatedSkills),
															)
														...
														onKeyDown={(e) => {
															if (e.key === 'Enter') {
																...
																dispatch(
																	creatureBuilderActions.setSkills(
																		updatedSkills,
																	),
																)
																setEditingSkillIndex(null)
						...
						<Grid item xs={12}>
							<Typography variant="caption" color="text.secondary">
								Click a skill chip to edit its rank. Tier {state.tier} default
								ranks: Primary {getSkillRanks(state.tier).primary}, Secondary{' '}
								{getSkillRanks(state.tier).secondary}
							</Typography>
						</Grid>
						<Grid item xs={12} md={4}>
							<Autocomplete
								...
								value={immunities}
								onChange={(_, newValue) =>
									dispatch(creatureBuilderActions.setImmunities(newValue))
								}
								sx={{
						...
						<Grid item xs={12} md={4}>
							<Autocomplete
								...
								value={resistances}
								onChange={(_, newValue) =>
									dispatch(creatureBuilderActions.setResistances(newValue))
								}
								sx={{
									'& .MuiAutocomplete-inputRoot': {
										alignContent: 'flex-start',
						...
						<Grid item xs={12} md={4}>
							<Autocomplete
								...
								value={weaknesses}
								onChange={(_, newValue) =>
									dispatch(creatureBuilderActions.setWeaknesses(newValue))
								}
								sx={{
									'& .MuiAutocomplete-inputRoot': {
										alignContent: 'flex-start',
						...
						{attacks.map((attack, index) => (
							<Box
								...
								sx={{
									...
									border: '1px solid',
									borderColor:
										editingAttackIndex === index ? 'primary.main' : 'divider',
									borderRadius: 1,
									bgcolor:
									...
									<Grid container spacing={1.5}>
										...
										<Grid item xs={12} sm={6}>
											<TextField
												...
												value={
													attack.weaponDamage ??
													getWeaponDamage(state.tier || 0, state.archetype)
												}
												onChange={(e) =>
													handleUpdateAttack(index, {
														...attack,
														weaponDamage: parseInt(e.target.value) || 0,
													})
												}
											...
											<Autocomplete
												...
												renderInput={(params) => (
													<TextField
														{...params}
														label="Properties"
														placeholder="agile, reach, pierce..."
													/>
												)}
											/>
										</Grid>
									...
									<Autocomplete
										...
										renderOption={(props, option) => (
											<Box component="li" {...props}>
												<Box>
													...
													<Typography variant="caption" color="text.secondary">
														{option.properties.join(', ') || 'No properties'} •{' '}
														{option.damageType}
													</Typography>
												</Box>
											</Box>
										...
										onChange={(_, value) => {
											if (value) {
												...
												presetWithDamage.damage = formatDamageString(
													baseDamage,
													weaponDamage,
												)
												dispatch(
										...
										onInputChange={(_, newInputValue) =>
											setAttackSearchInput(newInputValue)
										}
									/>
									<Button
										size="small"
									...
									<Grid container spacing={1.5}>
										...
										<Grid item xs={12} sm={6}>
											<Box sx={{ pt: 1 }}>
												...
												<Typography variant="body2" sx={{ fontWeight: 600 }}>
													{newAttack.baseAttribute &&
													newAttack.weaponDamage !== undefined
														? formatDamageString(
						...
						{abilities.map((ability, index) => (
							<Box
								...
								sx={{
									...
									border: '1px solid',
									borderColor:
										editingAbilityIndex === index ? 'primary.main' : 'divider',
									borderRadius: 1,
									bgcolor:
									...
									<>
										...
										>
											<Box>
												...
												>
													{ability.actionType &&
														getActionTypeIcon(ability.actionType as ActionType)}
													<Typography variant="subtitle2">
							...
							{!showCustomAbilityForm ? (
								<Box>
									<Autocomplete
										...
										onInputChange={(_, newInputValue) =>
											setAbilitySearchInput(newInputValue)
										}
										renderInput={(params) => (
											<TextField
												{...params}
												label="Select Preset Ability"
