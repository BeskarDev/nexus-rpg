...
class FirebaseService {
	...
	async getDocument(collectionId: string, docId: string): Promise<CharacterDocument | null> {
		...
		if (this.isDevelopment()) {
			...
			if (mockChar) {
				console.log('🔧 Development mode: Using mock character:', mockChar.personal.name)
				return mockChar
			}
		}
	...
	async updateDocument(character: CharacterDocument): Promise<void> {
		...
		if (this.isDevelopment()) {
			console.log('🔧 Development mode: Mock save for character:', character.personal.name)
	...
	async deleteDocument(character: CharacterDocument): Promise<void> {
		...
		if (this.isDevelopment()) {
			console.log('🔧 Development mode: Mock delete for character:', character.personal.name)
			return Promise.resolve()
		}
