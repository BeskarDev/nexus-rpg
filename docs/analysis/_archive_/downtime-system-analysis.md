...
> **Archived 2026-08-18.** Split into two open GDDs: core downtime fixes (`scenes/downtime-core-fixes-gdd.md`) and settlement & market layer (`world/settlement-and-market-gdd.md`). §4.2 faction agendas superseded by `world/factions/FACTION_SYSTEM_GDD.md`.
...
>
> **References:** [Downtime Overview](../../06-scenes/04-downtime/00-overview.md) | [Downtime Activities](../../06-scenes/04-downtime/activities.md) | [Scenes & Time Scales](../../06-scenes/01-scenes-time-intervals.md) | [Challenges](../../06-scenes/07-challenges/00-overview.md) | [Social Intrigue](../../06-scenes/07-challenges/01-social-intrigue.md) | [Travel](../../06-scenes/07-challenges/02-travel.md) | [Crafting Professions](../../06-scenes/05-crafting-professions/00-overview.md) | [NPCs and Relationships](../../02-adventurers/05-npc-relations.md)
...
> **Superseded:** this sketch is replaced by the full [Faction Turns system](../world/factions/FACTION_SYSTEM_GDD.md) (per-session faction turns, Might die + tags, goal clocks, collisions). The migration map lives in that GDD's §11. The sketch below is kept for reference until the downtime docs are re-pointed.
