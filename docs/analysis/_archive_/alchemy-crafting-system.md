...
> **Archived 2026-08-18.** Superseded. Field alchemy shipped in a simpler, talent-gated form ([Crafting Professions](../../06-scenes/05-crafting-professions/00-overview.md)) that the owner considers final — the modular Essence/Binder/recipe economy proposed here was not adopted and conflicts with the shipped model. A future analysis of the **full crafting rules** (downtime crafting, ingredient gathering, professions beyond field alchemy) should start fresh against the shipped systems; see the trackboard.
>
...
>
> **Related Analyses:** [Downtime System Analysis](./downtime-system-analysis.md) | [Magic Item System Analysis](../equipment/magic-items/MAGIC_ITEM_SYSTEM_ANALYSIS.md) | [Materials Mechanical Effects Analysis](../equipment/materials-mechanical-effects-analysis.md) | [Non-Magical Equipment Analysis](../equipment/non-magical-equipment-analysis.md)
...
See the [Magic Item System Analysis](../equipment/magic-items/MAGIC_ITEM_SYSTEM_ANALYSIS.md) for the full enchantment framework.
