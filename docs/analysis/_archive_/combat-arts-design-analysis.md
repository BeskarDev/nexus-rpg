...
> **Archived 2026-08-18.** Analysis complete; actionable outputs extracted into two open GDDs: `combat/combat-art-fixes-gdd.md` (difficulty rule, renames, design principles) and `combat/new-combat-arts-gdd.md` (expansion catalog).
