...
> **Archived 2026-08-18.** All 11 roadmap priorities shipped; every school reaches R5 and the remaining R3 seeds are deliberately parked (owner ruling 2026-07-17: additions only below 5 spells per rank). Spell counts and status tables in §2, §7.5, §9 and Appendix A predate the final expansion passes (actual totals: 201 arcane, 285 mystic). **§6 (damage scaling) and §16 (healing scaling) remain the canonical frameworks** referenced by the spell-design, creature-design, magic-item-design and talent-design skills.
>
