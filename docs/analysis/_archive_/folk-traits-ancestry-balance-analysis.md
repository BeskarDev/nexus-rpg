...
> **Archived 2026-08-18.** The audit (§2–§7, appendices) is complete; its actionable outputs were extracted into two open GDDs: `characters/folk-rework-gdd.md` (recommendations R1–R8 + rework designs) and `characters/cultural-abilities-gdd.md` (cultural abilities subsystem).
