...
> **⚠️ Superseded (July 2026):** [genre/sword-and-sorcery-genre-review-v2.md](../world/genre/sword-and-sorcery-genre-review-v2.md) is the working document. It records owner rulings that settle several items below (notably: the short-break HP reset is deliberate design — the Recoveries proposal in §3.1 is rejected as a default rule). This file remains as the reference for full mechanical argumentation.
