...
> **Archived 2026-08-18.** Roadmap P0–P2 shipped in the 2026-07-17/19 balance and expansion passes (148 talents, zero stubs); the base system is complete for its current scope (owner ruling). The only open work — R4–R5 prestige talents (P4) — moved to the successor GDD: [`../../prestige-talents-gdd.md`](../../prestige-talents-gdd.md). Inventory tables and gap lists in this document and the `skills/` workbenches describe the pre-2026-07-19 talent file and are stale.
>
