...
**Setup levers** — states Twilight emits: **darkness as terrain** (Darkness, Moon Sphere's dim veil — an area where sight fails and shadows have weight), *frightened* (terrors given form in the dark), *slowed* (the night's grasping cold), **concealment** (Shadow Meld, Cloak of Night — allies unseen), and *asleep* (dream-mist, the school's hardest state).

**Payoff levers** — Twilight hunts inside the dark it made: shadow attacks bite harder on targets who cannot see them coming, terror compounds against the already *frightened* (Terrors of the Dark feeding on Aura of Fear), and the sleeping or slowed are collected at leisure. Cold-cast deficit: in honest daylight against a calm foe, Twilight's offense is the weakest of the mystic damage kits — its curve assumes the field is already dim and afraid.

**Extenders** — *prolong* through standing night (its zones hold for a scene, keeping every shadow-payoff live), *refresh* fear each round (the aura re-applies as long as the dark endures), *convert* along the fear ladder (unease → *frightened* → the nightmare made real in Nightmare Realm), and the Shadow Clone flanking as a second body that keeps pressure while the caster hides.

**Solo engine** (multi-turn): T1 Darkness over the courtyard (the field goes dark, the party's shadow-eyes see, the enemy's do not) → T2 Aura of Fear inside it (*frightened* enemies stumbling blind) → T3 Moonbeam collecting the terrified one by one. Gated by concentration on the darkness, Focus, and counterplay — any strong light source (a Light caster, a bonfire) burns the whole engine down, the built-in school rivalry.

**Party interlock**: **emits** concealment (the rogue's dream), *frightened*, *slowed*, *asleep*, and darkness that blinds enemies — ambush currency: a sleeping sentry or an unseen approach is an encounter decided before it starts. **wants** allies who can fight in the dark it makes (dark-sighted folk, blind-fighters) and burst damage to spend the sleeping/frightened window before it breaks. Cross-player line: Twilight's mist drops the gate guards into sleep and the party walks through a war that never happens.
...
| 1 | 7 | Cloak of Night, Curse of Twilight, Dusk Veil, Haunting Shadows, Lunar Weapon, Moon Sphere, Shadow Meld |
| 2 | 12 | Augury, Aura of Fear, Darkness, Fangs of the Dark, Moonbeam, Shadow Mantle, Shadow Step, Silent Night, Sleep, Terrors of the Dark, Twilight Bind, Written in the Stars |
| 3 | 5 | Divination, Gaseous Form, Moonlit Mirror, Nightmare Realm, Shadow Clone |
| 4 | 5 | Dreamwalking, Eclipse, Embrace of Night, Prophecy, Veil of Secrets |
| 5 | 0 | — |
...
|-------|-----|-----|-----|-----|-----|-----|
| moon | Night's Grasp | Moon Sphere, Lunar Weapon | Moonbeam | — (Moonbeam Heighten) | Eclipse | ✨ Everlasting Night |
| dreams | Whispers of Doubt | — | Sleep, Terrors of the Dark | Nightmare Realm | Dreamwalking | ✨ Dream Realm |
| secrets | Dark Sight, Shadow Veil | Shadow Meld, Cloak of Night, Dusk Veil (QA) | Silent Night, Darkness, Fangs of the Dark, Shadow Mantle | ✨ Shadow Passage | Veil of Secrets | ✨ Shadowform |
...
**Coverage**: 29 of 30 trait×rank slots hold a published spell, a seed, or a Heighten extension. Honest gap: dreams R1 (Sleep anchors the trait at R2). Moon R5 is now seeded by Everlasting Night (the R2 spell's retired name, reseeded as enduring region-scale night). Only published spells count as real coverage; proposed entries are undesigned seeds (principle 19).
...
| Everlasting Night | 5 | Control / setup + extender | Night that does not lift (moon and secrets traits): region-scale enduring darkness as the moon trait's capstone. The retired name of the R2 spell (now *Darkness*), reseeded at the scale the name promises. Ritual, concentrate or costly anchor, counterplay through strong light and dawn rites. |
...
(✨ = undesigned seed)
1. **Moon chain**: Night's Grasp (R0) → Moon Sphere / Lunar Weapon (R1) → Moonbeam (R2) → Moonbeam Heighten (R3+) → Eclipse (R4) → ✨ Everlasting Night (R5)
...
3. **Secrets chain**: Dark Sight / Shadow Veil (R0) → Shadow Meld / Cloak of Night / Dusk Veil (R1) → Silent Night / Darkness / Fangs of the Dark / Shadow Mantle (R2) → ✨ Shadow Passage (R3) → Veil of Secrets (R4) → ✨ Shadowform (R5)
...
### Setup + Payoff Combos
(✨ = undesigned seed)
- ✅ **Darkness → shadow advantage**: Darkness and Moon Sphere make the field dark → Shadow Meld, Stealth, and dark-sighted allies operate freely; Eclipse (R4) is the engine compressed into one spell (published, with caster-only sight through its dark)
...
- [x] **3 published spells per rank through R3**: R0: 5, R1: 7, R2: 12, R3: 5; R4: 5 published (P4.5), R5: 0 needs the seeded capstone batch
- [x] Defensive options: Shadow Veil (R0), Cloak of Night (R1), Dusk Veil (R1), Veil of Secrets (R4) published — thin by design (Weak role)
...
- [ ] **Trait × rank coverage**: 29/30 slots hold a published spell, seed, or Heighten extension; honest gap at dreams R1
