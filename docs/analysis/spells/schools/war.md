...
4. **Known gaps**: no published defensive spells, nothing above R2, "justice" and "triumph" under-covered — concept seeds exist for all slots but none are designed
...
**Synergy gaps**: R0–R2 has a working fear-and-steel engine but **nothing above it** — no published R3+ spell exists, so the engine never escalates (no mass-fear payoff, no battle-lord capstone). The fear-exploit is also informal (no published mechanical bonus vs *frightened*; it rides on the frightened condition's own banes). Building R3–R5 battle magic on this engine is the school's whole design agenda.
...
## Current Spell Inventory (11 published spells)
...
| Ancestral Blade | 3 | You call upon the spirits of fallen warriors, and a spectral weapon materializes beside you — a ghostly blade wielded by an ancestral champion who fights with tireless fury at your command. (R3 triumph/blood capstone — spectral ally) |
| Warrior's Pride | 3 | You channel the war gods' pride in martial excellence, wreathing yourself in golden fire that marks you as a champion beyond equal. Enemies quail before your prowess. (Fills R3 pride gap) |
