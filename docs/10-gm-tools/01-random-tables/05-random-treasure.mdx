...
A wand contains a single embedded spell and uses charges to cast it. Roll on the spell type and discipline/tradition tables below, then determine the specific spell using the Random Spell tables.

<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
| 1 | Slim rod | Runes glow faintly |
| 2 | Crystal spike | Warm to the touch |
| 3 | Bone needle | Hums when held |
| 4 | Glass tube | Faint arcane scent |
| 5 | Metal baton | Etched with sigils |
| 6 | Coral twig | Cold aura radiates |
| 7 | Jade sliver | Sparks on contact |
| 8 | Obsidian shard | Inner light pulses |
| 9 | Amber wand | Whispers in silence |
| 10 | Silver needle | Smells of incense |
| 11 | Feathered stem | Vibrates softly |
| 12 | Ivory point | Leaves rustle nearby |
</RollableTable>

### Staff

A staff contains 3–5 embedded spells of differing ranks and stores more charges than a wand. Roll on the spell type and discipline/tradition tables below, then determine each spell using the Random Spell tables.

<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
| 1 | Twisted branch | Runes glow faintly |
| 2 | Gnarled oak | Warm to the touch |
| 3 | Iron-shod pole | Hums when held |
| 4 | Carved pillar | Faint arcane scent |
| 5 | Living wood | Etched with sigils |
| 6 | Petrified trunk | Cold aura radiates |
| 7 | Bronze-capped rod | Sparks on contact |
| 8 | Crystal-topped staff | Inner light pulses |
| 9 | Bone-carved staff | Whispers in silence |
| 10 | Serpent-wound pole | Smells of incense |
| 11 | Rune-etched pillar | Vibrates softly |
| 12 | Antler-crowned staff | Leaves rustle nearby |
</RollableTable>

#### Wand / Staff Spell Type
...
#### Wand / Staff Arcane Discipline

<RollableTable>
| d6 | Arcane Discipline |
| --- | --- |
| 1 | Evocation |
| 2 | Illusion |
| 3 | Conjuration |
