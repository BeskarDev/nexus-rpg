...
import { TreasureAutoRollerWrapper } from '@site/src/components/AutoRoller/TreasureAutoRollerWrapper'

# 🏆 Treasures

What the party found: the kind of thing, what it is made of, and roughly what it is worth.

<TreasureAutoRollerWrapper />

## What a hoard is worth

The value and Quality of treasure follow the adventuring tier it took to reach it. Three
categories, and the difference between them is what stood in the way:

| Category | Where it comes from |
| --- | --- |
| **Simple Loot** | Carried by a single creature of the party's own strength, or found in passing during exploration. |
| **Minor Treasure** | Behind a puzzle, a lethal trap, or a secret. A small hoard guarded by a group, or by one dangerous thing. |
| **Major Treasure** | The peak of a hoard: a conquered dungeon, a defeated leader, a finished quest. |

These tables give the CATEGORY and TYPE of a treasure rather than a specific object. What it
turns out to be is yours to decide.
...
> Any reward can be traded down: one item for `1d3` of the next Quality lower, and again from
> there (1 → 1d3 → 2d3 → 3d3). So `1 x Q4` may become `1d3 x Q3`, or `2d3 x Q2`.

Roll **2d12** for each reward: the first die gives the treasure type, the second the specific
item of that type. Reroll either die when the result does not fit the situation. To force
something other than a valuable, roll `1d6+6` instead for one item of the highest Quality
available.

These tables roll **mundane** items only. Whether a given treasure is enchanted is the GM's call,
and the guideline is Quality 4 or higher.

## Treasure Value by Quality
...
{/* gen:table:treasureData.treasureTypes#0 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Treasure Type |
| --- | --- |
| 1-6 | Valuable |
...
<TableFold label="Valuables" rows={12}>

{/* gen:table:treasureData.valuables#1 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Valuable |
| --- | --- |
| 1 | Coins / Currency |
...
<TableFold label="Utility" rows={6}>

{/* gen:table:treasureData.utility#2 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Utility |
| --- | --- |
| 1-2 | Gear |
...
<TableFold label="Wearable" rows={12}>

{/* gen:table:treasureData.wearableSlots#3 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Slot |
| --- | --- |
| 1 | Face |
...
<TableFold label="Armor / Shield" rows={10}>

{/* gen:table:treasureData.armorShield#4 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Armor / Shield |
| --- | --- |
| 1 | Leather |
...
<TableFold label="Weapon / Spell Catalyst" rows={12}>

{/* gen:table:treasureData.weaponCatalyst#5 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Forms and Details — Coins / Currency" rows={12}>

{/* gen:table:treasureData.valuableDetails.Coins / Currency#6 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Trinket / Charm" rows={12}>

{/* gen:table:treasureData.valuableDetails.Trinket / Charm#7 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Painting / Pottery" rows={12}>

{/* gen:table:treasureData.valuableDetails.Painting / Pottery#8 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Statuette / Idol" rows={12}>

{/* gen:table:treasureData.valuableDetails.Statuette / Idol#9 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Fabrics / Papyrus" rows={12}>

{/* gen:table:treasureData.valuableDetails.Fabrics / Papyrus#10 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Hide / Pelt" rows={12}>

{/* gen:table:treasureData.valuableDetails.Hide / Pelt#11 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Salt / Spice / Dye" rows={12}>

{/* gen:table:treasureData.valuableDetails.Salt / Spice / Dye#12 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Oil / Perfume" rows={12}>

{/* gen:table:treasureData.valuableDetails.Oil / Perfume#13 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Bone / Scales" rows={12}>

{/* gen:table:treasureData.valuableDetails.Bone / Scales#14 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Beverage / Grain" rows={12}>

{/* gen:table:treasureData.valuableDetails.Beverage / Grain#15 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Raw Metal / Timber" rows={12}>

{/* gen:table:treasureData.valuableDetails.Raw Metal / Timber#16 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
<TableFold label="Forms and Details — Gem" rows={12}>

{/* gen:table:treasureData.valuableDetails.Gem#17 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Form | Detail |
| --- | --- | --- |
...
> **Game-Specific Materials**: These tables include all special materials from Nexus RPG, including magical metals (Mithril, Adamantite), unique crystals (Solarite, Lunarite), monster-derived materials (Dragon scales, Phantom-silk), and legendary substances (Dreamweave, Divine essence). For details on specific material properties, see the Special Materials section in Magic Items.

**Metals and Minerals**

<TableFold label="Materials — Metals and Minerals" rows={12}>

{/* gen:table:treasureData.qualityMaterials.metalsAndMinerals#18 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Materials — Gems" rows={12}>

{/* gen:table:treasureData.qualityMaterials.gems#19 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
...
<TableFold label="Materials — Wood and Plants" rows={12}>

{/* gen:table:treasureData.qualityMaterials.woodAndPlants#20 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
...
<TableFold label="Materials — Organics" rows={12}>

{/* gen:table:treasureData.qualityMaterials.organics#21 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
...
<TableFold label="Materials — Textiles and Fibers" rows={12}>

{/* gen:table:treasureData.qualityMaterials.textiles#22 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
...
<TableFold label="Materials — Ceramics" rows={12}>

{/* gen:table:treasureData.qualityMaterials.ceramics#23 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
...
<TableFold label="Materials — Spices and Dyes" rows={12}>

{/* gen:table:treasureData.qualityMaterials.spicesAndDyes#24 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
| 1 | Common salt | Sea salt | Saffron | Phoenix spice |
| 2 | Wild herbs | Dried herbs | Cinnamon | Ambrosia powder |
| 3 | Clay pigments | Ochre dyes | Indigo | Nectar of gods |
| 4 | Bark dye | Madder root | Cloves | Starlight dye |
...
<TableFold label="Materials — Grain and Beverages" rows={12}>

{/* gen:table:treasureData.qualityMaterials.grainAndBeverages#25 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
...
<TableFold label="Materials — Oil and Perfumes" rows={12}>

{/* gen:table:treasureData.qualityMaterials.oilAndPerfumes#26 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Low-Quality | Medium-Quality | High-Quality | Supreme-Quality |
| --- | --- | --- | --- | --- |
...
| 7 | Lamp oil | Cedar oil | Elven perfume | Eternal fragrance |
| 8 | Pine resin | Sandalwood oil | Dwarven spirits | Phoenix essence |
| 9 | Tree sap | Jasmine oil | Moon oil | Primordial perfume |
| 10 | Fish oil | Myrrh | Unicorn tears | Heaven's scent |
| 11 | Tallow | Frankincense | Spirit essence | Titan's perfume |
| 12 | Cooking grease | Amber oil | Void perfume | Divine oil |
</RollableTable>
{/* /gen:table */}
...
<TableFold label="Gear" rows={12}>

{/* gen:table:treasureData.utilityDetails.Gear#27 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Alchemical" rows={20}>

{/* gen:table:treasureData.utilityDetails.Alchemical#28 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
| 13 | Burning | Tinder | Ignited |
| 14 | Blinding | Chalk powder | Scattered |
| 15 | Choking | Sealed jar | Broken open |
| 16 | Paralytic | Venom elixir | Splashed |
| 17 | Soothing | Salve | Rubbed on skin |
| 18 | Petrifying | Crystal vial | Shattered |
| 19 | Signaling | Oil flask | Poured |
...
<TableFold label="Tool (d20)" rows={20}>
...
<TableFold label="Supply (d10)" rows={10}>

{/* gen:table:treasureData.utilityDetails.Supply#29 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Spell Scroll" rows={12}>

{/* gen:table:treasureData.utilityDetails.Spell Scroll#30 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Script | Binding |
| --- | --- | --- |
...
<TableFold label="Knowledge" rows={20}>

{/* gen:table:treasureData.utilityDetails.Knowledge#31 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Description" rows={12}>

{/* gen:table:treasureData.wearableDescription#32 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Wearable Items (d6)" rows={6}>

{/* gen:table:treasureData.wearableItems#33 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
{/* gen:table:treasureData.wearableItems#34 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Leather" rows={12}>

{/* gen:table:treasureData.armorDetails.Leather#35 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Banded Leather" rows={12}>

{/* gen:table:treasureData.armorDetails.Banded Leather#36 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Chain Mail" rows={12}>

{/* gen:table:treasureData.armorDetails.Chain Mail#37 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Scale Mail" rows={12}>

{/* gen:table:treasureData.armorDetails.Scale Mail#38 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Helmet" rows={12}>

{/* gen:table:treasureData.armorDetails.Helmet#39 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Buckler" rows={12}>

{/* gen:table:treasureData.armorDetails.Buckler#40 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Light Shield" rows={12}>

{/* gen:table:treasureData.armorDetails.Light Shield#41 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Heavy Shield" rows={12}>

{/* gen:table:treasureData.armorDetails.Heavy Shield#42 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Breastplate" rows={12}>

{/* gen:table:treasureData.armorDetails.Breastplate#43 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Plate Harness" rows={12}>

{/* gen:table:treasureData.armorDetails.Plate Harness#44 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Axe" rows={12}>

{/* gen:table:treasureData.weaponDetails.Axe#45 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Blade" rows={12}>

{/* gen:table:treasureData.weaponDetails.Blade#46 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Bow" rows={12}>

{/* gen:table:treasureData.weaponDetails.Bow#47 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Brawling" rows={12}>

{/* gen:table:treasureData.weaponDetails.Brawling#48 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Crossbow" rows={12}>

{/* gen:table:treasureData.weaponDetails.Crossbow#49 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Mace" rows={12}>

{/* gen:table:treasureData.weaponDetails.Mace#50 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Polearm" rows={12}>

{/* gen:table:treasureData.weaponDetails.Polearm#51 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Thrown" rows={12}>

{/* gen:table:treasureData.weaponDetails.Thrown#52 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Arcane Conduit" rows={12}>

{/* gen:table:treasureData.weaponDetails.Arcane Conduit#53 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Mystic Talisman" rows={12}>

{/* gen:table:treasureData.weaponDetails.Mystic Talisman#54 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
...
<TableFold label="Wand" rows={12}>

{/* gen:table:treasureData.weaponDetails.Wand#55 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
| 1 | Crystal-tipped | Arcane Wand | inner light pulsing |
| 2 | Bone-carved | Mystic Wand | a warm touch |
| 3 | Ironwood | Arcane Wand | tiny rune etchings |
| 4 | Silver-veined | Mystic Wand | a soft humming |
| 5 | Obsidian-cored | Arcane Wand | a cold, smooth surface |
| 6 | Coral-tipped | Mystic Wand | sea-polished iridescence |
| 7 | Meteorite-infused | Arcane Wand | faint crackling along its length |
| 8 | Antler-wrapped | Mystic Wand | braided cord binding |
| 9 | Glass-threaded | Arcane Wand | shifting colour refraction |
| 10 | Chitin-sheathed | Mystic Wand | a soft resonant buzz |
| 11 | Fossil-veined | Arcane Wand | ancient runes faintly etched |
| 12 | Shell-inlaid | Mystic Wand | moonlight gleam at the tip |
</RollableTable>
{/* /gen:table */}
...
<TableFold label="Staff" rows={12}>

{/* gen:table:treasureData.weaponDetails.Staff#56 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Material | Form/Variant | Detail |
| --- | --- | --- | --- |
| 1 | Gnarled Darkwood | Arcane Staff | faintly glowing sigils |
| 2 | Ironwood | Mystic Staff | prayer cord wrappings |
| 3 | Crystal-capped | Arcane Staff | a pulsing inner light |
| 4 | Bone-crowned | Mystic Staff | carved faces on the shaft |
| 5 | Metal-banded | Arcane Staff | runes etched between each ring |
| 6 | Driftwood | Mystic Staff | a sea-bleached smoothness |
| 7 | Meteorite-inlaid | Arcane Staff | faint electrical hum at its core |
| 8 | Antler-forked | Mystic Staff | small spirit fetishes |
| 9 | Elderwood | Arcane Staff | bark still intact, never quite still |
| 10 | Stone-headed | Mystic Staff | a polished stone at the crown |
| 11 | Coral-branched | Arcane Staff | a cold, sea-grown texture |
| 12 | Fossilised | Mystic Staff | ancient creature bone construction |
</RollableTable>
{/* /gen:table */}
...
<TableFold label="Magical Utility Types (d12)" rows={10}>

{/* gen:table:treasureData.magicUtilityTypes#57 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d12 | Utility |
| --- | --- |
| 1-2 | Alchemical |
...
<TableFold label="Ammo (d6)" rows={6}>

{/* gen:table:treasureData.magicUtilitySubtables.Ammo#58 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d6 | Ammo |
| --- | --- |
| 1 | Arrow |
...
<TableFold label="Everyday Object" rows={20}>

{/* gen:table:treasureData.magicUtilitySubtables.Everyday Object#59 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable paired>
...
<TableFold label="Container" rows={12}>

{/* gen:table:treasureData.magicUtilitySubtables.Container#60 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable paired>
...
<TableFold label="Instrument (d6)" rows={6}>

{/* gen:table:treasureData.magicUtilitySubtables.Instrument#61 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable paired>
...
<TableFold label="Body Part" rows={12}>

{/* gen:table:treasureData.magicUtilitySubtables.Body Part#62 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable paired>
...
<TableFold label="Natural (d8)" rows={8}>

{/* gen:table:treasureData.magicUtilitySubtables.Natural#63 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable paired>
...
{/* gen:table:treasureData.magicItemNamingPatterns#64 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d4 | Naming Pattern |
| --- | --- |
| 1 | [Noun] [Item] |
...
<TableFold label="Utility Names" rows={20}>

{/* gen:table:treasureData.magicItemNames.utility#65 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
...
<TableFold label="Wearable Names" rows={20}>

{/* gen:table:treasureData.magicItemNames.wearable#66 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d20 | Adjective 1 | Noun 1 | Adjective 2 | Noun 2 |
| --- | --- | --- | --- | --- |
...
<TableFold label="Armor / Shield Names" rows={20}>

{/* gen:table:treasureData.magicItemNames.armor#67 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d20 | Adjective 1 | Noun 1 | Adjective 2 | Noun 2 |
| --- | --- | --- | --- | --- |
...
<TableFold label="Weapon Names" rows={20}>

{/* gen:table:treasureData.magicItemNames.weapon#68 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d20 | Adjective 1 | Noun 1 | Adjective 2 | Noun 2 |
| --- | --- | --- | --- | --- |
...
<TableFold label="Spell Catalyst Names" rows={20}>

{/* gen:table:treasureData.magicItemNames.spellCatalyst#69 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable>
| d20 | Adjective 1 | Noun 1 | Adjective 2 | Noun 2 |
| --- | --- | --- | --- | --- |
...
<TableFold label="Magic Item Effects" rows={12}>

{/* gen:table:treasureData.magicItemEffects#70 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
...
| 9 | Movement | Enables special travel or repositioning | Quick Action / Activation | Wielder or Allies |
...
<TableFold label="Is The Item Cursed (d12)" rows={7}>
...
| 12 | Blessed / Ward-Bound | The item is protected against curses and perhaps even repels cursed beings. |
</RollableTable>
...
<TableFold label="Curse Signs (d6)" rows={6}>
...
<TableFold label="Curse Effects" rows={12}>

{/* gen:table:treasureData.magicItemCurseEffects#71 — from the roller data by `bun run content:gen`. Do not edit: change the JSON. */}
<RollableTable singleRoll>
