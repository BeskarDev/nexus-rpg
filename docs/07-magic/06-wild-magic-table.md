...
**Random Locations:** When an effect teleports creatures to "random locations," the GM chooses valid unoccupied spaces within the specified range, distributing them evenly around the area or rolling randomly for each creature's direction and distance.
...
| 23 | **Mass Teleportation.** 2/3/4/5/6 creatures in close/close/short/short/medium radius (including caster) teleport to random unoccupied locations in medium range (GM distributes or rolls for each). |
...
| 26 | **Scatter.** All creatures in close range (except caster) teleport to random unoccupied locations in medium range (GM distributes or rolls 1d8 for direction and distance for each). Affects 2/3/4/5/6 creatures. |
...
| 30 | **Dimensional Door.** Portal appears at caster's location and another in short/medium/medium/long/very long range (GM chooses destination). Creatures can move through as if adjacent for brief/short/short/medium/medium duration. |
...
| 33 | **Mass Polymorph.** All creatures in close/close/short/short/medium radius transform into identical tiny harmless creatures (GM chooses form). Retain mental attributes for brief/brief/short/short/medium duration. |
...
| 94 | **Turn Theft.** Random creature in close/short/medium/medium/long range (roll if multiple) loses next turn. Caster gains additional Action next turn. |
...
| 99 | **Causal Break.** Caster can have effects before causes (take action after seeing result, attack before moving to range, etc.). GM determines reasonable limits. Lasts brief/brief/short/short/medium duration. |
