...
> **Heightened** <br/> <strong>(Rank 5)</strong> You raise the sandstorm in medium range of the target location instead, and a creature that ends their turn inside takes 10 damage (ignore AV) from the scouring sand.
...
**Effect** <br/> You become one with the storm, transforming into a living tempest of elemental energy.<br/>On a success, you gain the following effects:<br/>- You are able to fly and gain +1 Movement per turn.<br/>- You gain 20 temporary HP.<br/>- You are immune to lightning damage and gain resistance against frost and physical damage.<br/>- Whenever you are hit by a melee attack, the attacker takes +4 lightning damage (ignore AV).<br/>- Whenever you deal blast or lightning damage, add your Mysticism to the damage.<br/>This form lasts for a short duration. You can immediately recast this spell as an Action at the end of the duration to remain in this form for a longer time.
...
> **Heightened** <br/> <strong>(Rank 5)</strong> The affected area covers an extreme distance in all directions from the target location. The Flood option's wave deals +16 damage (ignore 1/2 AV), and the Split option's closing trench deals +20 damage (ignore 1/2 AV), instead.
...
**Effect** <br/> You crack the skin of the world and call the fire beneath it through the wound, and a tower of lava bursts upward with a sound like a god clearing their throat.<br/>On a success, a magma geyser erupts from an unoccupied point on the ground within range for a medium duration while you concentrate. The geyser and each space in melee range of it are difficult terrain. Any creature that enters the geyser's area or starts their turn in it takes 8 fire damage (ignore AV).<br/>Once on each of your turns, you can spend your Quick Action to direct the geyser to erupt, sending a surge of lava in a short blast (cone) in a direction you choose. Roll Spirit + Mysticism vs. the Dodge of each creature in the cone. On a success, each creature takes 12 fire damage (ignore AV) and is briefly burning (4). The geyser vents its pressure with each eruption and then builds anew, so it can only erupt once per turn.<br/>The geyser is a natural-looking volcanic feature. It cannot be moved once placed.
...
**Effect** <br/> You breathe out and the storm breathes in, and for one suspended moment everything within a great distance of you falls still as the eye opens around you.<br/>On a success, you become the eye of the storm for a medium duration while you concentrate. The effect extends in long range of you, moving with you. While the eye holds, apply the following effects:<br/>- You are immune to blast, frost, and lightning damage.<br/>- The area within the eye is calm. All wind, rain, and natural or magical weather effects within it are stilled.<br/>- Within the eye, your <em>tempest</em> spells gain +1 boon and deal +2 additional damage of their type.<br/>- At the start of each of your turns, up to three bolts of lightning crash down at points of your choice within the eye. Each bolt targets a creature in close range of its point. Roll Spirit + Mysticism vs. their Dodge. On a success, deal 10 lightning damage (ignore AV) to that creature.<br/>- At the edge of the eye, the storm rages all the harder for its stillness at the center. Any creature that crosses from outside the eye into it, or from inside to out, takes 6 blast damage (ignore AV) from the buffeting transition winds.
