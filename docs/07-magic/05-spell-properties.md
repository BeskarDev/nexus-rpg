...
| curse | This spell binds a lingering malediction to the target. A creature can suffer any number of different curses at the same time, but only one instance of the same curse. A curse is not a condition and can't be removed by effects that end conditions. It ends with its stated duration, or early through magic that lifts curses, such as *Break Curse*. |
...
| strike | When you cast this spell, choose one weapon you are holding and roll an attack with it, using your spellcasting skill (Spirit + Mysticism for mystic spells, Mind + Arcana for arcane spells). On a hit, use your spell power instead of the attack's base damage, then apply the spell's effects. This attack is a basic attack and can't be combined with Combat Arts. |
