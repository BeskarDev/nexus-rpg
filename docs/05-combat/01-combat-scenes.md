...
| Disarm | Choose one item the target holds and roll Strength + Athletics vs. their Parry or Dodge (whichever is higher). For a two-handed item or shield, you suffer +1 bane on your roll.
Weak. The chosen item is knocked to the ground directly below them.
Strong. The chosen item is knocked away to a random close location or you can grab it with a free hand (your choice).
Critical. The chosen item is knocked away to a random close location or you can grab it with a free hand (your choice). If it is knocked away, it is also stuck there. Any creature attempting to grab onto the item must roll Strength + Athletics as an Action. They pull the item free if they succeed. |
...
Instead of an attack, you can also attempt to grapple the enemy if they are in melee range. |
