...
At the start of combat, first, determine if one or more groups involved are surprised (see below). After that, every adventurer rolls for Initiative!
...
Adventurers in the same Initiative as enemies act before them. Once, after rolling Initiative, adventurers can choose to act at a slower Initiative than what they rolled. This decision remains for all rounds of combat.
