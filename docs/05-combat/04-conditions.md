...
| Name | Description |
| --- | --- |
| bleeding (X) | When you take any amount of damage, also take X damage (ignore AV). At the end of your turns, roll Strength + Fortitude to end the condition early. You or one of your allies can also use an Action to roll Spirit + Nature to quickly bandage up the wound. On a success, the condition ends early. |
