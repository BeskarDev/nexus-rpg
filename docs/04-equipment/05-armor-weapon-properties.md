...
| rigid X | You suffer +X bane(s) on the following rolls:<br/>- Strength and Agility rolls for any kind of movement (sneaking, sleight of hand, sprinting, jumping, climbing, swimming, etc.)<br/>- Arcana rolls to cast spells. <br/>If you wear or wield multiple rigid items, you suffer all their penalties combined. |
| simple | You don‘t suffer the +1 bane for attacking with this weapon while you haven‘t learned the skill it requires. |
