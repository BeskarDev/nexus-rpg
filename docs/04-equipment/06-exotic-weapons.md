...
When crafting an exotic weapon, choose one or more of the following properties and increase the weapons cost by the amount specified for each property.

**Balanced (+100 coins).** Reduce this weapon‘s heavy property by one step (min. d6).

**Covering (+250 coins).** Increase this shield’s heavy property by one step (max. d12). The shield can be placed down using an Action to act as a stationary cover of medium Size from a direction of your choice without you holding the item. You can use another Action to pick the item up again.

**Elegant (+100 coins).** This non-heavy melee weapon gains the agile property.

**Massive (+100 coins).** This non-light melee weapon gains the heavy (d8) property and increases it‘s load by 1. It is also considered a heavy weapon for calculating it’s cost as a magic item.
