...
Explore the different aspects of magic items:

### [Cost Tables](./cost-tables)
Detailed pricing for base items, magic item costs, special materials, and enchantments across all quality tiers.

### [Magic Item Effects](./effects)
Available bonuses and magical enhancements that magic items can provide, including weapon bonuses, armor bonuses, and spell power enhancements.

### [Special Materials](./materials)
Unique materials like Mithril, Dragon Scales, and Adamantite that provide special properties to weapons and armor.
