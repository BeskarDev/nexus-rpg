...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 0 (light) | d6 | d6 | d4 | d4-1 | 7 | 8 | 7 |

**Skills:** Fighting (1), Perception (1), Stealth (1), Survival (1)

**Attacks:**

- **Bite**. 5/7/9 damage. On a strong or critical hit, the target suffers bleeding (2).
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 0 (light) | d4 | d8 | d4 | d4-2 | 6 | 9 | 7 |

**Skills:** Fighting (1), Perception (1), Stealth (1)

**Attacks:**

- **Venomous Bite** (*pierce*). 5/7/9 poison damage. On a strong or critical hit, the target is poisoned for a short duration.

**Abilities:**

- **Blindsense (Close) (Passive).** This creature can perceive its surroundings at close range without relying on sight using heat detection.
- **Ambush Predator (Passive).** This creature deals +3 damage against surprised targets.

---

### **Tomb Guardian** (Medium Automaton)
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 2 (natural heavy) | d6 | d4 | d4 | d4-2 | 8 | 6 | 7 |
...
- **Stone Fist** (*crush*). 6/9/12 damage.
...
- **Eternal Vigil (Passive).** This creature does not require sleep and cannot be surprised while guarding its designated area.
- **Crumbling (Passive).** When this creature is reduced to 0 HP, it crumbles to dust. It cannot be repaired, only recreated.
...
- **Life Drain** (*target: vs. Resist*). 5/7/9 necrotic damage.

**Abilities:**

- **Undead Nature (Passive).** This creature is immune to bleeding, being charmed, poisoned, or falling unconscious.
- **Incorporeal Movement (Passive).** This creature can move through other creatures and objects as if they were difficult terrain. It takes 3 damage if it ends its turn inside an object.
- **Sunlight Sensitivity (Passive).** While in sunlight, this creature has +1 bane on attack rolls.

---

### **Satyr** (Medium Humanoid)
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 1 (natural light) | d6 | d8 | d6 | d6 | 7 | 8 | 7 |

**Skills:** Athletics (1), Fighting (1), Influence (1), Perception (1), Stealth (1)

**Attacks:**

- **Horns** (*crush*). 5/7/9 damage.
- **Shortsword** (*agile, light, pierce*). 5/7/9 damage.

**Abilities:**

- **Magic Resistance (Passive).** This creature gains +1 boon on saves against spells and other magical effects.
- **Woodland Stride (Passive).** This creature treats difficult terrain in forests as normal terrain.

---

### **Gnoll Scout** (Medium Humanoid)
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 1 (light) | d8 | d6 | d4 | d4 | 8 | 7 | 7 |

**Skills:** Athletics (1), Fighting (1), Perception (1), Survival (1)

**Attacks:**

- **Bite** (*crush*). 6/9/12 damage.
- **Spear** (*pierce, reach, two-handed*). 6/9/12 damage.

**Abilities:**

- **Rampage (Passive).** When this creature reduces a creature to 0 HP with a melee attack, it can move close and make a bite attack as a Quick Action.

---

### **Harpy Fledgling** (Medium Monstrosity)
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 1 (natural light) | d4 | d8 | d6 | d4 | 6 | 8 | 7 |

**Skills:** Fighting (1), Perception (1), Stealth (1)

**Attacks:**

- **Claws** (*agile*). 5/7/9 damage.

**Abilities:**

- **Flying (Passive).** This creature can fly with 2 Movement per turn. If on the ground, it can only spend 1 Movement during its turn in total.
- **Distracting Screech (Action, 1/day).** One creature within short range must roll Spirit + Fortitude vs. TN 7 or be distracted and suffer +1 bane on their next attack.

---

### **Pirate** (Medium Humanoid)
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 1 (light) | d6 | d6 | d4 | d6 | 7 | 7 | 7 |

**Skills:** Archery (1), Athletics (1), Fighting (1), Perception (1), Streetwise (1)

**Attacks:**

- **Cutlass** (*slash*). 5/7/9 damage.
- **Dagger** (*agile, light, pierce, thrown (short)*). 5/7/9 damage.

**Abilities:**

- **Sea Legs (Passive).** This creature is immune to penalties from unstable footing, such as on a ship's deck.
- **Dirty Fighting (Passive).** Once per combat, this creature can blind or distract an enemy with a dirty trick, giving it +1 bane on its next attack.

---

### **Tribal Warrior** (Medium Humanoid)
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 2 (natural light) | d6 | d6 | d6 | d4 | 7 | 7 | 7 |

**Skills:** Athletics (1), Fighting (1), Perception (1), Survival (1)

**Attacks:**

- **Handaxe** (*light, slash, thrown (short)*). 5/7/9 damage.
- **Javelin** (*bundle, light, thrown (medium)*). 5/7/9 damage.
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 10 | 1 (light) | d4 | d6 | d8 | d6 | 6 | 7 | 8 |

**Skills:** Influence (1), Lore (1), Mysticism (1), Perception (1)

**Attacks:**

- **Staff** (*crush, two-handed*). 4/6/8 damage.

**Abilities:**

- **Innate Spellcasting (Passive).** This creature can cast the following spells rolling Spirit + Mysticism once per scene each: *Light*, *Minor Healing*.
- **Divine Blessing (Passive).** This creature gains +1 boon on saves against necrotic damage and being frightened.
