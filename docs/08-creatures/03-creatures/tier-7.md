...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 2x70 | 14 (heavy) | d12 | d6 | d10 | d8 | 15 | 11 | 13 |

**Skills:** Athletics (4), Fighting (4), Fortitude (4), Influence (4), Perception (4)

**Immunities:** cold damage

**Attacks:**

- **Greataxe** (*heavy (d12), slash, two-handed*). 16/29/42 damage.
- **Ice Boulder** (*range (very long), crush*). 15/27/39 cold damage. On a strong or critical hit, the target is slowed until the end of its next turn.

**Abilities:**

- **Cold Aura (Passive).** At the start of this creature's turn, each creature within melee range takes 5 cold damage.
...
- **Wing Attack.** This creature beats its wings. Each creature within close range must roll Agility + Athletics vs. TN 13 or take 9 damage and be knocked prone.

---

### **Death Knight** (Medium Undead)
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 2x70 | 14 (heavy) | d12 | d8 | d10 | d8 | 14 | 12 | 13 |

**Skills:** Athletics (4), Fighting (4), Fortitude (4), Insight (4), Mysticism (4), Perception (4)
...
- **Longsword** (*pierce, versatile +1*). 15/27/39 damage plus 8 necrotic damage.

**Abilities:**

- **Undead Nature (Passive).** This creature is immune to bleeding, being charmed, frightened, poisoned, or falling unconscious.
- **Magic Resistance (Passive).** This creature has +1 boon on saves against spells and other magical effects.
- **Marshal Undead (Passive).** Unless surprised, undead within short range have +1 boon on saves against effects that turn undead.
- **Innate Spellcasting (Passive).** This creature can cast the following spells rolling Spirit + Mysticism once per scene each: *Command*, *Dispel Magic*, *Hold Person*.
- **Hellfire Orb (Action, recharge (d6)).** This creature hurls a magical ball of fire at a point it can see within long range. Each creature in a short range sphere must roll Agility + Athletics vs. TN 13. On a failure, a creature takes 15 fire damage and 15 necrotic damage, or half on a success.
- **Deathly Wrath (Elite Trigger).** When this creature loses its first life pool, it unleashes a wave of necrotic energy. All creatures within short range must roll Spirit + Fortitude vs. TN 13 or take 10 necrotic damage and be frightened until the end of their next turn.

**Quick Actions:**

- **Parry.** This creature adds +3 to its Parry against one melee attack that would hit it.
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 70 | 8 (natural light) | d12 | d6 | d12 | d12 | 14 | 12 | 14 |

**Skills:** Arcana (4), Insight (4), Lore (4), Perception (4)

**Attacks:**

- **Tentacle** (*reach*). 13/23/33 damage. On a hit, the target must roll Spirit + Fortitude vs. TN 13 or become diseased. The diseased creature can breathe only underwater.

**Abilities:**

- **Amphibious (Passive).** This creature can breathe air and water.
- **Mucous Cloud (Passive).** While underwater, this creature is surrounded by mucus. A creature that touches this creature or hits it with a melee attack while within melee range must roll Spirit + Fortitude vs. TN 13 or become diseased.
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 70 | 14 (natural heavy) | d12 | d8 | d8 | d4 | 15 | 12 | 13 |

**Skills:** Athletics (4), Fighting (4), Perception (4), Stealth (4), Survival (4)

**Immunities:** lightning damage

**Attacks:**

- **Bite** (*crush*). 15/27/39 damage. On a strong or critical hit and if the target is smaller than this creature, the target is swallowed. While swallowed, the creature is blinded and restrained, has total cover against attacks from outside, and takes 8 acid damage at the start of each of this creature's turns.
- **Constrict** (*crush*). 14/25/36 damage. On a hit, the target is grappled and restrained.
- **Lightning Breath** (*recharge (d6)*). Roll Strength + Fortitude vs. Dodge. Target all creatures in a line up to medium range. On a success, each target suffers 18 lightning damage.
...
| HP | AV | STR | AGI | SPI | MND | Parry | Dodge | Resist |
|----|----|----|----|----|-----|-------|-------|--------|
| 70 | 14 (heavy) | d12 | d8 | d10 | d8 | 15 | 12 | 13 |

**Skills:** Athletics (4), Fighting (4), Fortitude (4), Insight (4), Perception (4)

**Attacks:**

- **Morningstar** (*crush*). 15/27/39 damage.
