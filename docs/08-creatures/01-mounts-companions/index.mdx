...
For the full list of available mounts, see the [Mounts](./01-mounts-companions/mounts.md) page.

## Mount Equipment

For the different kinds of mount equipment available, see the [Mount Equipment](./01-mounts-companions/equipment.md) page.
...
For detailed companion traits, see the [Companion Traits](./01-mounts-companions/traits.md) page.
