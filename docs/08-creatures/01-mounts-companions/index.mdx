...
For the full list of available mounts, see the [Mounts](./mounts.md) page.

## Mount Equipment

For the different kinds of mount equipment available, see the [Mount Equipment](./equipment.md) page.
...
For detailed companion traits, see the [Companion Traits](./traits.md) page.
