...
|-----------|------|----------------|----------|
| [Apothecary](/docs/basic-rules/quickstart-characters/apothecary) | Striker / Utility | Archery, Crafting, Nature | Poisons, remedies, precision |
| [Barbarian](/docs/basic-rules/quickstart-characters/barbarian) | Striker | Fighting, Athletics, Fortitude | Massive damage, rage mechanics |
...
| [Brawler](/docs/basic-rules/quickstart-characters/brawler) | Controller / Striker | Fighting, Fortitude, Streetwise | Unarmed, grapples, dirty tricks |
...
| [Engineer](/docs/basic-rules/quickstart-characters/engineer) | Controller / Utility | Crafting, Education, Archery | Siege, traps, devices |
...
| [Gladiator](/docs/basic-rules/quickstart-characters/gladiator) | Controller / Striker | Fighting, Athletics, Influence | Reach control, grapples, takedowns |
...
| [Priest](/docs/basic-rules/quickstart-characters/priest) | Support | Mysticism, Lore, Influence | Healing, wards, divine calm |
...
| [Swashbuckler](/docs/basic-rules/quickstart-characters/swashbuckler) | Striker / Controller | Fighting, Athletics, Streetwise | Dirty tactics, dual-wielding |
