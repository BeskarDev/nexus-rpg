			...
			abilities: [
				{
					id: '1',
					title: 'Shield Bash',
					description: 'Use shield as weapon',
					tag: 'Combat Art',
					rank: 1,
				},
			],
...
describe('Character Sheet Functional Integration Tests', () => {
	...
	it('renders header navigation elements', () => {
		...
		expect(
			container.querySelector('[data-testid="ArrowBackIosNewIcon"]'),
		).toBeDefined()
		expect(container.querySelector('[data-testid="SaveIcon"]')).toBeDefined()
		expect(
			container.querySelector('[data-testid="DownloadIcon"]'),
		).toBeDefined()
	})
