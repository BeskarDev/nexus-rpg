 ...
 */
export const simulateSelectChange = async (
 ...
 */
export const expectElementToContainText = (
	element: HTMLElement,
	text: string,
) => {
 ...
 */
export const expectSpellCardContent = (
	spellName: string,
	expectedRank?: number,
	...
	if (expectedDescription) {
		expect(
			screen.getByText(expectedDescription, { exact: false }),
		).toBeInTheDocument()
	}
}
 ...
 */
export const expectPrintButtonToWork = async (
	mockPrint: ReturnType<typeof vi.fn>,
) => {
 ...
 */
export const testJsonImport = async (
