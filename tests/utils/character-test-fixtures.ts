import { Character, CharacterDocument, Companion, Skill, Weapon, Item, Spell, Ability } from '@site/src/types/Character'
...
export const createCharacterDocument = (overrides: Partial<Character> = {}): CharacterDocument => ({
...
export const createTestCompanion = (overrides: Partial<Companion> = {}): Companion => ({
  id: crypto.randomUUID(),
  name: 'Test Companion',
...
export const createTestAbility = (overrides: Partial<Ability> = {}): Ability => ({
  id: crypto.randomUUID(),
  title: 'Test Ability',
