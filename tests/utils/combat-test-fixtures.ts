		...
		abilities: [
			{
				name: 'Pack Tactics',
				description:
					'Gains +1 boon on attack rolls when allies are adjacent to the target.',
			},
		],
	},
	{
		...
		attacks: [
			...
			},
			{
				...
				damage: '15/20/25',
				description:
					'A torrent of dragonfire that incinerates everything in its path.',
				range: 'Long',
			},
		],
		abilities: [
			{
				...
				description:
					'When a life pool is depleted, all attributes increase by one die size and gain +3 weapon damage.',
			},
			{
				name: 'Legendary Resistance',
				description:
					'Can automatically succeed on any resistance roll 3 times per day.',
			},
			{
				name: 'Frightful Presence',
				description:
					'All creatures within Long range must make Spirit + Fortitude vs TN 16 or become frightened.',
			},
		],
	},
]
