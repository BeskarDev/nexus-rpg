...
- **Damage Notes**: Light magic harms through shining radiance or burning energy; attacks can overwhelm darkness, lies, or corruption.
...
- **Damage Notes**: Twilight attacks affect the mind or dreamscape, inducing fear, confusion, or chilling effects.
...
- **Damage Notes**: Life magic damages by **overloading internal systems**, nerves, or organs, or by overwhelming life force itself.
...
- **Damage Notes**: Tempest attacks strike with storms, shock, freezing effects, or explosive force.
...
- **Damage Notes**: Peace magic harms defensively or as deterrents, using physical force, concussive waves, or mental pressure.
...
- **Damage Notes**: War magic damages directly in battle through weapons, fire, and explosive strikes.
...
- **Damage Notes**: Evocation damages through raw elemental forces, explosions, and destructive energy.
...
- **Damage Notes**: Illusion attacks harm through mental strain, fear, disorientation, or shattering perception.
...
- **Damage Notes**: Conjuration harms via summoned creatures, objects, or bound forces in versatile ways.
...
- **Damage Notes**: Telepathy damages minds or spirit, overwhelming thoughts or life force; subtle mental attacks.
...
- **Damage Notes**: Telekinetics harms by moving, crushing, or striking targets with kinetic energy or force waves.

### 3.6 Necromancy
- **Aspects**: decay, undeath, siphoning, defilement, puppetry  
- **Role Spread**: Excels: Control | Decent: Offense, Utility | Weak: Healing, Support, Defense  
- **Damage Types**: Necrotic, Poison, Physical  
- **Damage Notes**: Necromancy damages through decay, corruption, and animating corpses; attacks drain or manipulate life.
...
4. **Damage Type Integration**:  
   - Use one or more **assigned damage types** for the Tradition/Discipline.  
   ...
   - Refer to **damage notes** to preserve thematic flavor (e.g., Life internal overload, Necromancy decay, Twilight mind attacks).
...
- Incorporate **aspects and multiple damage types** with clear thematic flavor.  
